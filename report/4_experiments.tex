...
Figures~\ref{fig:ctr_qf} and \ref{fig:ctr_ce} show the impact of query frequency and click entropy on the CTR-prediction task. 

\subsubsection{Prediction}
The results of the relevance prediction task can be seen in Figures~\ref{fig:rel_qf} and~\ref{fig:rel_ce}.x
